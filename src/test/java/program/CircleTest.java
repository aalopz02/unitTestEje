...
public class CircleTest 
{
    ...
    public void testAreaRepeated() {
       ...
       public void testPointsMultiple() {
           ...
           assertEquals((double) java.lang.Math.round((double)(java.lang.Math.sqrt(java.lang.Math.pow(circle.radius,2)-java.lang.Math.pow(1.0,2)))*100)/100, (double) java.lang.Math.round((double) circle.getcirclePoint(5.0)*100)/100);  
        }

    @Test   
    @DisplayName("Circle Perimeter multiple Test")
    public void testPerimeterMultiple() {
        assertEquals((double) java.lang.Math.round((double)(2* java.lang.Math.PI*5)*100)/100, java.lang.Math.round((double) circle.getPerimeter()*100)/100);
        assertEquals((double) java.lang.Math.round((double)(2* java.lang.Math.PI*4)*100)/100, java.lang.Math.round((double) circle.getPerimeter()*100)/100);   }
